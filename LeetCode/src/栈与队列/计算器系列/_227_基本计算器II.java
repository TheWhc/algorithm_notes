...
/**
 * @ClassName: _227_基本计算器II
 * @Author: whc
 * @Date: 2021/07/18/20:44
 */
public class _227_基本计算器II {
	...
	public static void main(String[] args) {
		_227_基本计算器II _227_基本计算器II = new _227_基本计算器II();
		System.out.println(_227_基本计算器II.calculate("3/2"));
	}
}
